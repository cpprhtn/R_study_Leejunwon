/*
 * exec_stmt_multi.c - simple interactive statement-execution program
 * with support for SSL connections and multiple-statement execution
 */
...
#include "process_multi_statement.c"
